...
public class Avalibility {
	...
	@SequenceGenerator(name="avalibileties", sequenceName="availability_seq", allocationSize=1)
	private Integer id;
	@Column(name="user_id")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Avalibility other = (Avalibility) obj;
		if (dateId == null) {
	...
	public String toString() {
		return "Avalibility [id=" + id + ", userId=" + userId + ", dateId=" + dateId + ", startTime=" + startTime
				+ ", endTime=" + endTime + "]";
	}
